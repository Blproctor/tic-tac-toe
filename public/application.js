...
// require('./assets/scripts/new_file.js')
...
function onClickBox(td, content) {
  ...
  if (!content) {
    ...
    // messages.html('')
  } else if (!won && (table.find('#box1').hasClass('cross') || table.find('#box1').hasClass('circle')) && (table.find('#box2').hasClass('cross') || table.find('#box2').hasClass('circle')) && (table.find('#box3').hasClass('cross') || table.find('#box3').hasClass('circle')) && (table.find('#box4').hasClass('cross') || table.find('#box4').hasClass('circle')) && (table.find('#box5').hasClass('cross') || table.find('#box5').hasClass('circle')) && (table.find('#box6').hasClass('cross') || table.find('#box6').hasClass('circle')) && (table.find('#box7').hasClass('cross') || table.find('#box7').hasClass('circle')) && (table.find('#box8').hasClass('cross') || table.find('#box8').hasClass('circle')) && (table.find('#box9').hasClass('cross') || table.find('#box9').hasClass('circle'))) {
    checkForDraw();
  } else {
    //  spaceTaken()
